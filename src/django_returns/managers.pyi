...
class IncrementedReturnsQuerySet(BaseReturnsQuerySet):
    ...
    def get_result(self, *args, **kwargs) -> Result: ...
    def earliest_result(self, *args, **kwargs) -> Result: ...
    def latest_result(self, *args, **kwargs) -> Result: ...
    def create_result(self, *args, **kwargs) -> Result: ...
    def get_or_create_result(self, *args, **kwargs) -> Result: ...
    def update_or_create_result(self, *args, **kwargs) -> Result: ...
    def delete_result(self, *args, **kwargs) -> Result: ...
    def bulk_create_result(self, *args, **kwargs) -> Result: ...

    # Async safe versions return IOResult
    async def aget_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def aearliest_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def alatest_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def acreate_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def aget_or_create_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def aupdate_or_create_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def adelete_ioresult(self, *args, **kwargs) -> IOResult: ...
    async def abulk_create_ioresult(self, *args, **kwargs) -> IOResult: ...
